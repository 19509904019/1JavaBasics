...
public class SubClassTest {
    public static void main(String[] args) {
        // 知识点1：接口中声明的静态方法只能被接口来调用，不能使用实现类进行调用
        CompareA.method1();
//        SubClass.method1();   // 报错
        ...
        /*
         * 知识点3：类实现了两个接口，而两个接口中定义了同名同参数的方法
         * 默认方法的情况下，会报错  ----> 接口冲突
        ...
        /*
        知识点4：子类（或实现类）继承了父类并实现了接口，父类和接口中声明了同名同参数
        的方法。（其中，接口中的方法是默认方法）。默认情况下，子类（或实现类）在没有重
        写此方法的情况下，调用的是父类中的方法  ----> 类优先原则
         */
        sub.method4();
